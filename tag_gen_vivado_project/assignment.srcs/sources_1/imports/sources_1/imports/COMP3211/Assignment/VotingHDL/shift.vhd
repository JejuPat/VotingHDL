...
architecture behavioural of shift is
    ...
    signal bs_index   : integer := 0;
    signal rot_amt    : integer := 0;
...
begin
    bs_index <= to_integer(unsigned(i_key(KEY_SIZE - 1 downto KEY_SIZE - BS_WIDTH)));
    rot_amt  <= to_integer(unsigned(i_key(KEY_SIZE - BS_WIDTH - 1 downto KEY_SIZE - BS_WIDTH - R_WIDTH)));
