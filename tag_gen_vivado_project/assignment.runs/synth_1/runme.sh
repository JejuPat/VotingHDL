...
HD_PWD='C:/Users/Admin/Documents/Uni/COMP3211/Assignment/VotingHDL/tag_gen_vivado_project/assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voting_proc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voting_proc.tcl
