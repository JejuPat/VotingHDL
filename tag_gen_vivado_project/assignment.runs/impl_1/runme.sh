...
HD_PWD='C:/Users/Admin/Documents/Uni/COMP3211/Assignment/VotingHDL/tag_gen_vivado_project/assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voting_proc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source voting_proc.tcl -notrace
